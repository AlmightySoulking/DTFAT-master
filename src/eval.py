...
parser.add_argument('-b', '--batch-size', default=20, type=int, metavar='N', help='mini-batch size')
...
parser.add_argument("--loss", type=str, default="CE", help="loss function", choices=["BCE", "CE"])
